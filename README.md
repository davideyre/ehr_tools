...
3. Calculate Comorbidity Index - a script for Calculating Charlson and Elixhauser scores using diagnostic codes from 1-year lookback [Calculate Comorbidity Index.R](Calculate Comorbidity Index.R)
